...
AVATAR_PARTS = {
    ...
    "hat": [
        ...
        {"id": "star_headset", "name": "Star Headset"},
        {"id": "hunter_hood", "name": "Hunter Hood"},
        {"id": "kitty_bow_ears", "name": "Kitty Bow Ears"},
        {"id": "mischief_hood", "name": "Mischief Hood"},
    ],
    "accessory": [
        ...
        {"id": "stage_mic", "name": "Stage Mic"},
        {"id": "spirit_blade", "name": "Spirit Blade"},
    ...
    "face_extra": [
        ...
        {"id": "rune_marks", "name": "Rune Marks"},
        {"id": "whiskers", "name": "Whiskers"},
        {"id": "mischief_mark", "name": "Mischief Mark"},
    ],
    "outfit_pattern": [
        ...
        {"id": "moon_sigil", "name": "Moon Sigil"},
        {"id": "tiny_bows", "name": "Tiny Bows"},
        {"id": "bat_stars", "name": "Bat Stars"},
    ],
    "pet": [
